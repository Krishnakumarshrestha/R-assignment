...
ii) Using R, how would you calculate the square root of half of the average of the numbers 25.2, 15, 16.44, 15.3, and 18.6?
...
e)  Compute the exponential transformation of your answer to (d)

```{r}
exp(log(0.3))
```

f)  Identity R's representation of -0.00000000423546322 when printing this number to the console.
...
a)  create an object that stores the value
